...
BACKEND_DOWN_MSG = "백엔드 서버(8000번)에 연결할 수 없습니다. BE 터미널이 켜져 있는지 확인하세요."

st.title("📍 우리 지역 체크인")
st.caption("방문한 지역과 만족도를 기록하고, 내 기록과 전체 현황을 한눈에 확인하는 서비스입니다.")
...
tab_write, tab_mine, tab_overview = st.tabs(["기록 남기기", "내 기록", "전체 현황"])

# ══════════════════════════════════════════════════════════════
# 탭 1 · 기록 남기기
# ══════════════════════════════════════════════════════════════
with tab_write:
    st.caption("이름·지역·만족도·메모를 입력하고 '기록 저장'을 누르면 서버에 저장됩니다.")
...
# ══════════════════════════════════════════════════════════════
with tab_mine:
    st.caption("이름을 입력하면 그 사람이 남긴 기록만 모아 보여주고, 잘못 남긴 기록을 삭제할 수 있습니다.")
...
# ══════════════════════════════════════════════════════════════
with tab_overview:
    st.caption("전체 기록의 요약 통계와 지역별 만족도, 검색 조건이 적용된 기록 표를 보고 CSV로 내려받을 수 있습니다.")
